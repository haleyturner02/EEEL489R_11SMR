...
// Service 1 of the custom server
...
static const uint8_t SVC1_MEASUREMENT_UUID_128[ATT_UUID_128_LEN]       = DEF_SVC1_MEASUREMENT_UUID_128;
...
const struct attm_desc_128 custs1_att_db[CUSTS1_IDX_NB] = {
    ...
    [SVC1_IDX_MEASUREMENT_CHAR]         = {(uint8_t*)&att_decl_char, ATT_UUID_16_LEN, PERM(RD, ENABLE),
                                            0, 0, NULL},

    // Measurement Characteristic Value
    [SVC1_IDX_MEASUREMENT_VAL]          = {SVC1_MEASUREMENT_UUID_128, ATT_UUID_128_LEN, PERM(RD, ENABLE) | PERM(WR, ENABLE) | PERM(NTF, ENABLE) | PERM(WRITE_REQ, ENABLE),
                                            DEF_SVC1_MEASUREMENT_CHAR_LEN, 0, NULL},																		

    // Measurement Client Characteristic Configuration Descriptor
    [SVC1_IDX_MEASUREMENT_NTF_CFG]      = {(uint8_t*)&att_desc_cfg, ATT_UUID_16_LEN, PERM(RD, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE),
                                            sizeof(uint16_t), 0, NULL},

    // Measurement Characteristic User Description
    [SVC1_IDX_MEASUREMENT_USER_DESC]    = {(uint8_t*)&att_desc_user_desc, ATT_UUID_16_LEN, PERM(RD, ENABLE),
                                            sizeof(DEF_SVC1_MEASUREMENT_CHAR_USER_DESC) - 1, sizeof(DEF_SVC1_MEASUREMENT_CHAR_USER_DESC) - 1,
                                            (uint8_t *) DEF_SVC1_MEASUREMENT_CHAR_USER_DESC},
