...
void init_sensor(void) {
    ...
    P2IE |= BIT7;                   // Enable IRQ for PWM (will be enabled in function for getting sensor measurement)
...
void init_timer(void) {
    ...
    TB0CCR0 = 1421;
    TB0CCTL0 |= CCIE;           // Enable IRQ for Timer B0 CCR0 (will be enabled in function for getting sensor measurement)
